...
export class LanguageService {
  ...
  private translations: { [locale: string]: TranslationData } = {
    'en-US': {
      ...
      'reviews.review-submitted-successfully': "Review submitted successfully!",
      'reviews.rating-required': "Rating is required",
      'reviews.comment-required': "Comment is required",
      'reviews.share-experience': "Share your experience",
    ...
    'fr-FR': {
      ...
      'reviews.review-submitted-successfully': "Avis soumis avec succès !",
      'reviews.rating-required': "La note est requise",
      'reviews.comment-required': "Le commentaire est requis",
      'reviews.share-experience': "Partagez votre expérience",
      'reviews.no-reviews': "Aucun avis pour le moment",
